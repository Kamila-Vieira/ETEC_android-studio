...
public class bdModel extends SQLiteOpenHelper {
    ...
    public String criarTabela(){
        setCmdSQL("CREATE TABLE "
                + getTabela() + " (" + getId()
                + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                getNome() + " TEXT, " + getUsuario() + " TEXT, " +
                getSenha() + " TEXT" + ")"
        );
        return getCmdSQL();
    }
    ...
    public void insert(String tabela, credencialModel credencial) {
        ...
        valores.put(getNome(), credencial.getNome());
        valores.put(getUsuario(), credencial.getUsuario());
        valores.put(getSenha(), credencial.getSenha());
        dataBase.insert(tabela, null, valores);
    }
    ...
    public void update(String tabela, credencialModel credencial){
        ...
        valores.put(getUsuario(), credencial.getUsuario());
        valores.put(getSenha(), credencial.getSenha());
        dataBase.update(tabela, valores, getId() + "=" + credencial.getId(), null);
    }
